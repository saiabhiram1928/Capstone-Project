  ...
  useEffect(()=>{
    const FetchData = async()=>{
      try{
       ...
       setNotifications([{message : err.message,createdAt:Date.UTC}])
      }finally{
        setLoading(false)
      }
    }
    ...
    return (
     ...
     <Badge className="mb-5" overlap="circular" content={notifications.length}>
        <MenuHandler>
            <IconButton className="p" variant="text">
