  ...
  return (
    <div key={policy.policyId} className="border border-gray-200 p-4 rounded-lg bg-white shadow-sm mb-4">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
        ...
        <div><strong>Premium Amount:</strong> ${policy.premiumAmount.toFixed(2)}</div>
        <div><strong>Quote Amount:</strong> ${policy.quoteAmount.toFixed(2)}</div>
                ...
                <tbody className="bg-white divide-y divide-gray-300">
                  {policy.claims.map(claim => (
                    <tr key={claim.claimId}>
                      ...
                      <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-500">${claim.claimAmount.toFixed(2)}</td>
                      ...
                      <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-500">{claim.acceptedDate !== 'N/A' ? new Date(claim.acceptedDate).toLocaleDateString() : 'N/A'}</td>
                    </tr>
                  ))}
                </tbody>
              </table>
                ...
                <tbody className="bg-white divide-y divide-gray-300">
                  {policy.payments.map(payment => (
                    <tr key={payment.transactionId}>
                      ...
                      <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-500">${payment.paymentAmount.toFixed(2)}</td>
